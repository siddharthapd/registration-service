package com.techopedia.registration.swagger;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.techopedia.registration.endpoint"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "Registeration Rest API",
                "Registeration Rest API for registering users",
                "1.0",
